...
if __name__ == '__main__':
    ...
    cb_plot = DrawTrainMovingAvgPlotCallback(os.path.realpath('C:/SAIDA_RL/python/saida_agent_example/avoidReaver/save_graph/' + FILE_NAME + '_'+post_fix + '.png'), 10, 5, l_label=['episode_reward'])
